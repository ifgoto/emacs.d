...
(defun color-theme-tty-dark ()
  ...
  (color-theme-install
   '(color-theme-tty-dark
     ...
     (highlight ((t (:background "#00bfff" :foreground "yellow"))))
     ...
     (message-header-xheader-face ((t (:foreground "#00bfff"))))
     (message-mml-face ((t (:foreground "green"))))
     (message-separator-face ((t (:foreground "#00bfff"))))

     (modeline ((t (:background "white" :foreground "#00bfff"))))
     ...
     (secondary-selection ((t (:background "#00bfff"))))
     (show-paren-match-face ((t (:background "red"))))
